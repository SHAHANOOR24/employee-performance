...
<div class="container">
    <div class="left">
        <h1 class="general-info-label">ANGEL DETAILS</h1>
        ...
        <form id="myForm" method="get" action="angel.php">
            <div class="form-group">
                <label><b>Employee Name:</b> Angel</label>
            </div>
            <div class="form-group">
                <label><b>Employee Id:</b>7648</label>
            </div>  
            <div class="form-group">
                <label for="age"><b>Age:</b> 22</label>
            </div>  
            <div class="form-group">
                <label for="email"><b>Email:</b> angel@gmail.com</label>
            </div>
            <div class="form-group">
                <label for="mobile"><b>Mobile number:</b> 2347612907</label>
            </div>
            <div class="form-group">
                <label for="dep"><b>Department:</b> Coding</label>
            </div>
            <div class="form-group">        
                <label for="exp"><b>Experience:</b> 6 years</label>
            </div>
            <div class="form-group">
                <label for="sal"><b>Salary:</b> 70,000</label>
            </div>
            <div class="form-group">
                <label for="att"><b>Attendance:</b> 95%</label>
            </div>
            <div class="form-group">
                <label for="wor"><b>Working hours:</b> 7 hours</label>
            </div>
            <div class="form-group">
                <label for="gen"><b>Gender:</b> Female</label>
            </div>
        </form>
    </div>
    <div class="right">
        ...
        <!-- <img src="https://c4.wallpaperflare.com/wallpaper/437/647/684/taylor-swift-beautiful-teen-vogue-wallpaper-thumb.jpg" alt="angel image" class="profile-pic"> -->
        <form method="get" action="angel.php">
